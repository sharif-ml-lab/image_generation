...
def enhance_prompt(prompt):
  body_enahnce["messages"][-1]['content'] = f"Enhance the following prompt to have better better image as result: '{prompt}'. please just output prompts in string format like \"\""
