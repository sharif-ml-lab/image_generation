...
def inception_handler(gpath):
    ...
    return f"Mean Inception Score: {mean_is}, Standard Deviation: {std_is}"
...
def frechet_handler(gpath, rpath):
    ...
    return f"Frechet Inception Distance: {fid_score}"
...
def captioning_handler(gpath, cpath):
    ...
    return f"Mean Captioning Similarity: {mean_captioning}, Standard Deviation: {std_captioning}"
